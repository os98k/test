...
plt.show()
```
![output_7_0](https://user-images.githubusercontent.com/83074369/186090999-806ca716-f3ee-4a2a-803f-d725a786e615.png)
...
![output_16_0](https://user-images.githubusercontent.com/83074369/186091139-6e0c14b4-e279-4cc9-8ac9-49da1dcdd198.png)
...
for row,ser in netflix_movies_col_subset.iterrows() :
    ...
    elif ser["genre"] == "Documentries" :
        colors.append("blue")
    elif ser["genre"] == "Stand_Up" :
        colors.append("green")
    else:
        colors.append("black")
...
![output_25_0](https://user-images.githubusercontent.com/83074369/186091203-7eeb6314-bce4-42c6-8ea8-241570c2a90a.png)
...
are_movies_getting_shorter = "Yes, we are not certain"
print(are_movies_getting_shorter.center(75))
```

                              Yes, we are not certain                          
